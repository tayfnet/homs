(()=>{
  ...
  function sanitizeState(input){
    ...
    const rawCurrencies = Array.isArray(raw.currencies) && raw.currencies.length
      ? upgradeLegacyDefaultCurrencyCatalog(raw.currencies, raw.version)
      : null;
    const list = shouldReplaceLegacyDefaultCurrencyCatalog(rawCurrencies, raw.version)
      ? fallback
  ...
  function readState(){
    const stored = TAIF.core.utils.readOnlineState(MODULE_KEY, null);
